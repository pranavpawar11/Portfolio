...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="relative py-20 px-4 md:px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-950 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 z-10 relative">
          ...
          >
            I'm a passionate IT student and full-stack developer focused on building elegant and efficient web applications.
          </motion.p>
        </div>
